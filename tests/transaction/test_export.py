...
from database import SessionLocal  # noqa: F401 — old pattern, accessed at module level
from tests.helpers import get_account_id
from tests.factories import api_create_product, api_create_customer, api_create_supplier
