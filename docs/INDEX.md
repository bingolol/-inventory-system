...
| **查代码百科（架构/模块/类/运行）** | **[CODE_WIKI.md](./CODE_WIKI.md)** |
...
| 文档 | 用途 |
|------|------|
| [CODE_WIKI.md](./CODE_WIKI.md) | 代码百科：项目架构、模块职责、关键类与函数、依赖关系、运行方式（代码视角，与架构参考互补） |
...
README.md (项目入口)
    ...
    │        └──→ docs/架构参考.md (架构详解)
    │
    ├──→ docs/CODE_WIKI.md (代码百科 - 代码视角，架构参考互补)
    │
    ├──→ docs/INDEX.md (文档索引)
    │        │
    │        ├──→ CONTEXT.md (项目上下文 + 记账 Agent 技能)
    │        ├──→ docs/CODE_WIKI.md (代码百科)
    │        ├──→ docs/架构参考.md (架构详解)
    │        ├──→ docs/开发规范.md (开发规范)
    │        ├──→ docs/文件索引.md (文件分类)
    │        ├──→ docs/功能模块说明.md (模块详解)
...
*文档索引 v3.3 | 2026-07-17 | doc-type: catalog*
