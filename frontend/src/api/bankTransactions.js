...
export const reverseBankTransaction = (id) => api.post(`/bank-transactions/${id}/reverse`)

export default { getBankTransactions, createBankTransaction, reverseBankTransaction }
