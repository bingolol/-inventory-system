...
- Name: dashboard.spec.js >> 仪表盘 >> 统计数据展示 >> 库存总量数值为数字
- Location: tests\e2e\dashboard.spec.js:35:5
...
Locator: locator('.stat-value').nth(1)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.stat-value').nth(1)
