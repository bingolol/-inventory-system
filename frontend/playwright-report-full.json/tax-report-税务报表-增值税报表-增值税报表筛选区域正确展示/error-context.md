...
- Name: tax-report.spec.js >> 税务报表 >> 增值税报表 >> 增值税报表筛选区域正确展示
- Location: tests\e2e\tax-report.spec.js:28:5
...
Locator: locator('.vat-report-section').locator('text=按季度')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.vat-report-section').locator('text=按季度')
