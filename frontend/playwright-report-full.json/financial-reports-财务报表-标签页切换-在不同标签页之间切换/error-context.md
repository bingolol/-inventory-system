...
- Name: financial-reports.spec.js >> 财务报表 >> 标签页切换 >> 在不同标签页之间切换
- Location: tests\e2e\financial-reports.spec.js:95:5
    ...
    - main [ref=e109]:
      - generic [ref=e111]:
        ...
        - generic [ref=e126]:
          - tablist [ref=e130]:
            - tab "资产负债表" [ref=e132]
            - tab "利润表" [active] [selected] [ref=e133] [cursor=pointer]
            - tab "期初余额" [ref=e134]
