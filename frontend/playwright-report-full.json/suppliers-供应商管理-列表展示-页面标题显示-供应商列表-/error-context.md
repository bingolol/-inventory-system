...
- Name: suppliers.spec.js >> 供应商管理 >> 列表展示 >> 页面标题显示"供应商列表"
- Location: tests\e2e\suppliers.spec.js:29:5
...
Call log:
  - waiting for locator('.el-table__row') to be visible
    19 × locator resolved to 6 elements. Proceeding with the first one: <tr class="el-table__row">…</tr>
