...
- Name: reports.spec.js >> 报表统计 >> 页面加载 >> 报表页面正常加载
- Location: tests\e2e\reports.spec.js:11:5
...
Locator: locator('.page-title:has-text("报表统计")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.page-title:has-text("报表统计")')
