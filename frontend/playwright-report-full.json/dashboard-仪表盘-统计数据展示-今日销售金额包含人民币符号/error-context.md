...
- Name: dashboard.spec.js >> 仪表盘 >> 统计数据展示 >> 今日销售金额包含人民币符号
- Location: tests\e2e\dashboard.spec.js:49:5
...
Locator: locator('.stat-value').nth(3)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.stat-value').nth(3)
