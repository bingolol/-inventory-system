...
- Name: customers.spec.js >> 客户管理 >> 列表展示 >> 第一行数据包含有效内容
- Location: tests\e2e\customers.spec.js:25:5

# Error details

```
Error: locator.textContent: Error: strict mode violation: locator('.el-table__row:first-child') resolved to 2 elements:
    1) <tr class="el-table__row">…</tr> aka getByRole('row', { name: '中国联通宜宾分公司 编辑 删除' })
    2) <tr class="el-table__row">…</tr> aka getByText('吴江恒净净化设备经营部编辑删除')
