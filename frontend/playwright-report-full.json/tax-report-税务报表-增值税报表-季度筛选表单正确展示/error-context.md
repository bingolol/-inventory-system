...
- Name: tax-report.spec.js >> 税务报表 >> 增值税报表 >> 季度筛选表单正确展示
- Location: tests\e2e\tax-report.spec.js:40:5
...
Locator: locator('.vat-report-section').locator('.el-form-item:has-text("年份")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.vat-report-section').locator('.el-form-item:has-text("年份")')
