...
- Name: suppliers.spec.js >> 供应商管理 >> 编辑供应商 >> 打开编辑对话框并回填数据
- Location: tests\e2e\suppliers.spec.js:185:5
...
Call log:
  - waiting for locator('.el-table__row') to be visible
    20 × locator resolved to 6 elements. Proceeding with the first one: <tr class="el-table__row">…</tr>
