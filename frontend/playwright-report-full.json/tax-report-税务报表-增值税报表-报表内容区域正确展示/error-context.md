...
- Name: tax-report.spec.js >> 税务报表 >> 增值税报表 >> 报表内容区域正确展示
- Location: tests\e2e\tax-report.spec.js:133:5
...
Call log:
  - waiting for locator('.vat-report-section').locator('.el-form-item:has-text("年份")').locator('.el-select')
