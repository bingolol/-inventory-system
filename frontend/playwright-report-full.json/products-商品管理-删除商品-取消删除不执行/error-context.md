...
- Name: products.spec.js >> 商品管理 >> 删除商品 >> 取消删除不执行
- Location: tests\e2e\products.spec.js:301:5
...
Locator: locator('.el-table__row:first-child')
Expected substring: "信息系统服务"
Error: strict mode violation: locator('.el-table__row:first-child') resolved to 2 elements:
    1) <tr class="el-table__row hover-row">…</tr> aka getByRole('row', { name: '选择当前行 SKU-信息系统 信息系统服务 服务 个 ¥0' })
                          ...
                          - cell "编辑 删除" [ref=e445]:
                            - generic [ref=e447]:
                              ...
                              - button "删除" [ref=e450] [cursor=pointer]:
                                - generic [ref=e451]: 删除
                  - generic [ref=e455]:
                    - generic [ref=e456]: 共 8 条
                    - generic [ref=e459] [cursor=pointer]:
                      - generic:
                        - combobox [ref=e461]
                        - generic [ref=e462]: 20条/页
                      - img [ref=e465]
                    - button "上一页" [disabled] [ref=e467]:
                      - generic:
                        - img
                    - list [ref=e468]:
                      - listitem "第 1 页" [ref=e469]: "1"
                    - button "下一页" [disabled] [ref=e470]:
                      - generic:
                        - img
  - tooltip "确定删除? 取消 确定" [ref=e471]:
    - generic [ref=e472]:
      - generic [ref=e473]:
        - img [ref=e475]
        - text: 确定删除?
      - generic [ref=e477]:
        - button "取消" [active] [ref=e478] [cursor=pointer]:
          - generic [ref=e479]: 取消
        - button "确定" [ref=e480] [cursor=pointer]:
          - generic [ref=e481]: 确定
```
