...
- Name: customers.spec.js >> 客户管理 >> 分页功能 >> 修改每页条数
- Location: tests\e2e\customers.spec.js:61:5

# Error details

```
Error: locator.click: Error: strict mode violation: locator('.el-pagination .el-pagination__sizes .el-select') resolved to 2 elements:
...
Call log:
  - waiting for locator('.el-pagination .el-pagination__sizes .el-select')
