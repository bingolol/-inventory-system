...
- Name: customers.spec.js >> 客户管理 >> 列表展示 >> 页面标题显示"客户列表"
- Location: tests\e2e\customers.spec.js:31:5
...
Expected substring: "客户列表"
Error: strict mode violation: locator('.page-title') resolved to 3 elements:
    1) <span class="page-title">伙伴管理</span> aka getByRole('main').getByText('伙伴管理')
    2) <span data-v-14585336="" class="page-title">客户列表</span> aka getByText('客户列表')
    3) <span data-v-14585336="" class="page-title">供应商列表</span> aka getByText('供应商列表')
