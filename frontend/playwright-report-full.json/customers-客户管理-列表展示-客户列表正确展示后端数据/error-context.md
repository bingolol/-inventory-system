...
- Name: customers.spec.js >> 客户管理 >> 列表展示 >> 客户列表正确展示后端数据
- Location: tests\e2e\customers.spec.js:13:5
...
Locator: locator('th:has-text("联系人")')
Expected: visible
Error: strict mode violation: locator('th:has-text("联系人")') resolved to 2 elements:
    1) <th colspan="1" rowspan="1" scope="col" class="el-table_1_column_2 is-leaf el-table__cell">…</th> aka getByRole('columnheader', { name: '联系人' })
    2) <th colspan="1" rowspan="1" scope="col" class="el-table_2_column_8 is-leaf el-table__cell">…</th> aka getByLabel('供应商', { exact: true }).locator('th').filter({ hasText: '联系人' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('th:has-text("联系人")')
