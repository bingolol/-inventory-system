...
- Name: financial-reports.spec.js >> 财务报表 >> 页面加载 >> 默认选中资产负债表标签页
- Location: tests\e2e\financial-reports.spec.js:15:5
...
Expected substring: "资产负债表"
Error: strict mode violation: locator('.el-tabs__item.is-active') resolved to 2 elements:
    1) <div role="tab" tabindex="0" aria-selected="true" id="tab-income-statement" aria-controls="pane-income-statement" class="el-tabs__item is-top is-active">…</div> aka getByRole('tab', { name: '利润表' })
...
Call log:
  ...
  - waiting for locator('.el-tabs__item.is-active')
    2 × locator resolved to <div role="tab" tabindex="0" aria-selected="true" id="tab-income-statement" aria-controls="pane-income-statement" class="el-tabs__item is-top is-active">…</div>
      - unexpected value "利润表"
