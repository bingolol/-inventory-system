...
- Name: reports.spec.js >> 报表统计 >> 页面加载 >> 导出按钮可见
- Location: tests\e2e\reports.spec.js:22:5
...
Locator: locator('button:has-text("导出当前报表")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("导出当前报表")')
