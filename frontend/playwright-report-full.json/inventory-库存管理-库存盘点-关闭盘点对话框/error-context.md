...
- Name: inventory.spec.js >> 库存管理 >> 库存盘点 >> 关闭盘点对话框
- Location: tests\e2e\inventory.spec.js:211:5
...
Call log:
  - waiting for locator('.el-table__row') to be visible
    24 × locator resolved to 13 elements. Proceeding with the first one: <tr class="el-table__row">…</tr>
                      ...
                      - row "个 0 0 正常 ¥0.00 ¥0.00 ¥0.00 盘点" [ref=e305]:
                        ...
                        - cell "盘点" [ref=e324]:
                          - button "盘点" [ref=e327] [cursor=pointer]:
                            - generic [ref=e328]: 盘点
                      - row "个 0 0 正常 ¥0.00 ¥0.00 ¥0.00 盘点" [ref=e329]:
                        - cell [ref=e330]
                        - cell [ref=e331]
                        - cell [ref=e332]
                        - cell "个" [ref=e333]:
                        ...
                        - cell "盘点" [ref=e348]:
                          - button "盘点" [ref=e351] [cursor=pointer]:
                            - generic [ref=e352]: 盘点
                - generic [ref=e354]:
                  - generic [ref=e355]: 共 5 条
                  - generic [ref=e358] [cursor=pointer]:
                    - generic:
                      - combobox [ref=e360]
                      - generic [ref=e361]: 20条/页
                    - img [ref=e364]
                  - button "上一页" [disabled] [ref=e366]:
                    - generic:
                      - img
                  - list [ref=e367]:
                    - listitem "第 1 页" [ref=e368]: "1"
                  - button "下一页" [disabled] [ref=e369]:
                    - generic:
                      - img
```
