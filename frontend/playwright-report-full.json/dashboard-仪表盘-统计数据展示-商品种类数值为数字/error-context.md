...
- Name: dashboard.spec.js >> 仪表盘 >> 统计数据展示 >> 商品种类数值为数字
- Location: tests\e2e\dashboard.spec.js:28:5
...
Locator: locator('.stat-value').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.stat-value').first()
