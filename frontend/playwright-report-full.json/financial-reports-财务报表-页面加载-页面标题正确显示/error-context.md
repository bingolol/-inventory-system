...
- Name: financial-reports.spec.js >> 财务报表 >> 页面加载 >> 页面标题正确显示
- Location: tests\e2e\financial-reports.spec.js:11:5
...
Expected substring: "财务报表"
Error: strict mode violation: locator('.page-title') resolved to 2 elements:
    1) <span data-v-58e0dc09="" class="page-title">财务报表</span> aka getByRole('main').getByText('财务报表')
    2) <span data-v-6bfd2d2a="" class="page-title">期初余额设置</span> aka getByText('期初余额设置')
        ...
        - generic [ref=e126]:
          ...
          - tabpanel "利润表" [ref=e137]:
            - generic [ref=e138]:
              ...
              - generic [ref=e156]:
                - img [ref=e158]
                - paragraph [ref=e175]: 暂无数据，请先录入业务数据
```
