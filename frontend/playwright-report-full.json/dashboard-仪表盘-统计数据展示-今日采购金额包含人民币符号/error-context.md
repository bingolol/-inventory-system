...
- Name: dashboard.spec.js >> 仪表盘 >> 统计数据展示 >> 今日采购金额包含人民币符号
- Location: tests\e2e\dashboard.spec.js:42:5
...
Locator: locator('.stat-value').nth(2)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.stat-value').nth(2)
