...
- Name: products.spec.js >> 商品管理 >> 编辑商品 >> 打开编辑对话框并回填数据
- Location: tests\e2e\products.spec.js:223:5
...
Locator: locator('.el-dialog .el-form-item:has-text("商品名称") input')
Expected: "信息系统服务"
Timeout: 5000ms
