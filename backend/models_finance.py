...
class VATDeclaration(Base):
    ...
    total_revenue       = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    output_tax          = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    input_tax           = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    vat_payable         = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    carry_forward       = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
...
class SurchargeDeclaration(Base):
    ...
    vat_payable               = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    urban_construction_tax    = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    education_surcharge       = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    local_education_surcharge = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    total                     = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
