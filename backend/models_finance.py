...
class VATDeclaration(Base):
    ...
    total_revenue_l1    = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    output_tax_l1       = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    input_tax_l1        = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    vat_payable_l1      = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    carry_forward_l1    = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
...
class SurchargeDeclaration(Base):
    ...
    vat_payable_l1               = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    urban_construction_tax_l1    = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    education_surcharge_l1       = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    local_education_surcharge_l1 = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
    total_l1                     = Column(Numeric(14, 2), default=Decimal("0"), info={"tier":"L1","source":"external"})
