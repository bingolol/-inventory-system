...
#   2026-Q2: 41.58 × 0.035 = 1.46 — 因6月切换为一般纳税人，在5月底结清（凭证 2026-05-31）
...
EXPECTED_SURCHARGE = {
    ...
    "2026-05": Decimal("1.46"),      # Q2小规模附加税在切换点(5月底)结清
    "2026-06": Decimal("43.26"),     # 一般纳税人月申报（城建税减半）
}
...
EXPECTED_INCOME_TAX_DELTA = {
    ...
    "2026-05": Decimal("-76.69"),   # 2026年累计 3924.49 × 5% = 196.224 → 196.22，已272.91 → 冲回76.69（Q2附加税在5月底结清，累计利润减少1.46）
    "2026-06": Decimal("951.29"),   # 2026年累计 22950.19 × 5% = 1147.510 → 1147.51，已196.22 → 补提951.29
}
