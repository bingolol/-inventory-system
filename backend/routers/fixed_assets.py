...
def _to_out(asset) -> FixedAssetOut:
    return FixedAssetOut(
        ...
        original_value=asset.original_value_l1,
        salvage_rate=asset.salvage_rate_l3,
        useful_life=asset.useful_life_l3,
        depreciation_method=asset.depreciation_method_l3 or "年限平均法",
        start_date=asset.start_date_l1.isoformat() if asset.start_date_l1 else "",
        accumulated_depreciation=asset.accumulated_depreciation_l4,
...
def update_asset_with_invoice(
    ...
    return {
        ...
        "invoice": {
            ...
            "amount_without_tax": float(invoice.amount_without_tax_l1),
            "tax_amount": float(invoice.tax_amount_l1),
            "amount_with_tax": float(invoice.amount_with_tax_l1),
