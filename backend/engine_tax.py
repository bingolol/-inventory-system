...
class TaxAccrualEngine:
    ...
    def execute(self, account_id: int, period: str, taxpayer_type: str = "") -> Dict:
        ...
        revenue = _crd(self.db, ledger, "6001", close_dt)
        cogs = _bal(self.db, ledger, "6401", close_dt)
        opex = _bal(self.db, ledger, "6601", close_dt) + _bal(self.db, ledger, "6403", close_dt)
        cumulative_profit = revenue - cogs - opex
